// Lab Assignment #5.8 - Laplace Equation using Gauss-Seidel (Liebmann's Method)
// Solves: d2u/dx2 + d2u/dy2 = 0
// on a grid with Dirichlet boundary conditions
#include <stdio.h>
#include <math.h>
...
int main() {
    ...
    int N = n + 2;  // total grid including boundary
